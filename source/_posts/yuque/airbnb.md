...
date: 2019-03-05 21:56:15 +0800
tags: []
categories: 
---
转自 https://github.com/BingKui/javascript-zh
...
9. [类和构造器](#classes--constructors)
10. [模块](#modules)
11. [迭代器和发生器](#iterators-and-generators)
12. [属性](#properties)
13. [变量](#variables)
14. [提升](#hoisting)
15. [比较运算符和等号](#comparison-operators--equality)
16. [块](#blocks)
17. [控制语句](#control-statements)
18. [注释](#comments)
19. [空白](#whitespace)
20. [逗号](#commas)
21. [分号](#semicolons)
22. [类型转换和强制类型转换](#type-casting--coercion)
23. [命名规范](#naming-conventions)
24. [存取器](#accessors)
25. [事件](#events)
26. [jQuery](#jquery)
27. [ECMAScript 5 兼容性](#ecmascript-5-compatibility)
28. [ECMAScript 6+ (ES 2015+) 风格](#ecmascript-6-es-2015-styles)
29. [标准库](#standard-library)
30. [测试](#testing)
31. [性能](#performance)
32. [资源](#resources)
33. [JavaScript风格指南的指南](#the-javascript-style-guide-guide)
34. [许可证](#license)
35. [修正案](#amendments)
...
2. [类](#classes--constructors)
3. [对象简写](#es6-object-shorthand)
4. [对象简洁](#es6-object-concise)
5. [对象计算属性](#es6-computed-properties)
6. [字符串模板](#es6-template-literals)
7. [解构](#destructuring)
...
13. [迭代器和发生器](#iterators-and-generators)
14. [模块](#modules)
